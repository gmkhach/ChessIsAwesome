...
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!
	...
	$yourEmail = "info@chessisawesome.com"; // the email address you wish to receive these mails through
	$yourWebsite = "HTTP://CHESSISAWESOME.COM"; // the name of your website
	$thanksPage = 'thankyou.html'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
	$maxPoints = 5; // max points a person can hit before it refuses to submit - recommend 4
